...
function MatchLabel() {
  ...
  return (
    <dmb.MatchLabel>
      <dmb.MatchLabelSpan>
        <dmb.WinBlueLabelSpan win={true} >승리</dmb.WinBlueLabelSpan>
        <dmb.Font1Span>블루팀</dmb.Font1Span>
      </dmb.MatchLabelSpan>
      <dmb.MatchLabelSpan>
        <dmb.svgImg>
          <dmb.svgPath d={towerPath} win={true} />
        </dmb.svgImg>
        <dmb.Font1Span>0</dmb.Font1Span>
        <dmb.svgImg>
          <dmb.svgPath d={dragonPath} win={true} />
        </dmb.svgImg>
        <dmb.Font1Span>0</dmb.Font1Span>
        <dmb.svgImg>
          <dmb.svgPath d={BaronPath} win={true} />
        </dmb.svgImg>
        <dmb.Font1Span>0</dmb.Font1Span>
      </dmb.MatchLabelSpan>
      <dmb.MatchLabelSpan>
        <dmb.GoldImg src={`${process.env.PUBLIC_URL}` + `assets/images/yellow-coin-icon-original.svg`} />
        <dmb.Font1Span>00.0K</dmb.Font1Span>
      </dmb.MatchLabelSpan>
      <dmb.MatchLabelB>00</dmb.MatchLabelB>
      <b>VS</b>
      <dmb.MatchLabelB>00</dmb.MatchLabelB>
      <dmb.MatchLabelSpan>
        <dmb.GoldImg src={`${process.env.PUBLIC_URL}` + `assets/images/yellow-coin-icon-original.svg`} />
      ...
      <dmb.MatchLabelSpan>
        ...
        <dmb.Font1Span>0</dmb.Font1Span>
        <dmb.svgImg>
          <dmb.svgPath d={dragonPath} win={false} />
        </dmb.svgImg>
        <dmb.Font1Span>0</dmb.Font1Span>
        <dmb.svgImg>
          <dmb.svgPath d={BaronPath} win={false} />
        </dmb.svgImg>
        <dmb.Font1Span>0</dmb.Font1Span>
      </dmb.MatchLabelSpan>
      <dmb.MatchLabelSpan>
